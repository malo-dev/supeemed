...
export class ResidentService {
  constructor(
    ...
    private readonly employeRepository: Repository<Residence>,
  ) {}

  async findAll(): Promise<Promise<Residence> | any> {
  ...
  async create(leaveRequestData: Partial<Residence>) {
  ...
  async update(id: any, dataObject: Partial<Residence>) {
